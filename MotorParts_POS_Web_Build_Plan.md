...
- [x] **Task:** Temporarily create a `/test-db` page to confirm the full database layer works in the browser.
...
- [x] **Task:** Display all products with search and tab filters.
...
- [x] **Task:** Wire the charge button to `completeSale()`.
...
- [x] **Task:** Initialize the Supabase client and create the matching tables in Supabase.
...
- [x] **Task:** Green = synced, orange = pending, animated pulse while syncing.
